...
@implementation CameraScreencastsDataSource
{
...
- (NSString *)title
{
	return (browseTree != nil) ? browseTree.title : NSLocalizedString(@"Screencasts",@"Browse screencasts title");
}

- (NSString *)loadingCamerasText
{
	return NSLocalizedString(@"Loading Screencasts ...",@"Loading screencasts");
}

- (NSString *)noCamerasText
{
	return NSLocalizedString(@"No Screencasts",@"No screencasts");
}

- (NSString *)searchPlaceholderText
{
	return NSLocalizedString(@"Search Screencasts",@"Search screencasts");
}
